          ...
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <h2>Get In Touch</h2>
                <form action="https://formspree.io/f/moqzpbrd" method="POST" >
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" name="Phone No." value={formDetails.phone} placeholder="Phone No." onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
